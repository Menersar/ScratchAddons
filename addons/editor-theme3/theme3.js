...
const sidekickCategory = {
  id: null,
  settingId: "sidekick-color",
  colorId: "sidekick"
};
const saCategory = {
  settingId: "sa-color",
...
export default async function ({ addon, console }) {
  ...
  Blockly.Block.prototype.setColour = function (colour, colourSecondary, colourTertiary) {
    ...
    // Sidekick Blocks
    if (this.type.startsWith("sidekick_")) {
      colour = primaryColor(sidekickCategory);
      colourSecondary = secondaryColor(sidekickCategory);
      colourTertiary = tertiaryColor(sidekickCategory);
    }
